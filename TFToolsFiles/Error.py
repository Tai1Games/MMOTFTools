...
class ERRCODE(Enum):
    ...
    MAP_IS_NOT_CONECTED = 45
    MAP_NODE_NOT_ACCESIBLE = 46
    MAP_AUDIO_DOES_NOT_EXIST = 47
    MAP_IMAGE_DOES_NOT_EXIST = 48
    ...
    ITEM_KEY_REPEATED = 55
    ITEM_UNKNOWN_STAT = 56
    ITEM_UNKNOWN_GEARSLOT = 57
    ITEM_UNKNOWN_BEHAVIOUR = 58
